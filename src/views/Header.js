      ...
      <div class="w-full sticky top-0 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
          <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
            ...
            <nav class="hidden md:flex space-x-10 justify-start">
              <Link
                to={"/"}
              ...
              <div class="py-6 px-5 space-y-6">
                <div>
                  <Link
                    to={"/register"}
                    id="link_header_register"
                    class="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-blue-900 hover:bg-blue-600"
                    onClick={() => setIsMenuOpen(false)}
                  >
                    {" "}
                    Registrarse{" "}
